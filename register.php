	...
	<div class="wrapper">
		<div class="login_box">
			<div class="login_header">
				<h1>Nomad</h1>
				<h2>Because life is a journey!</h2>
					...
					<form action="register.php" method="POST">
						...
						<?php if (in_array("Your password must be between 5 and 30 characters.<br>", $error_array)) {
							echo "Your password must be between 5 and 30 characters.<br>";
						 	...
						 	else if (in_array("Your password can only contain english characters.<br>", $error_array)) {
							echo "Your password can only contain english characters.<br>";
						} 
						...
						<?php if (in_array("<span style = 'color: #14c800;'>Registration Successful! Go ahead and Log In!</span><br>", $error_array))
							echo "<span style = 'color: #14c800;'>Registration Successful! Go ahead and Log In!</span><br>"; ?>
